...
<div class="page-content">
	...
	<div class="page-head">
		...
		<div class="page-title">
			<h1>
				<spring:message code="menu.dashboard" text="" /><small><spring:message code="" text="" /></small>
			</h1>
		</div>
		<!-- END PAGE TITLE -->
	</div>
	...
	<ul
		class="page-breadcrumb breadcrumb breadcrumb-arrow breadcrumb-arrow breadcrumb-arrow hide">
		<li><a href="#"><spring:message code="page.home" text="" /></a><i class="fa fa-circle"></i></li>
		<li class="active"><spring:message code="menu.dashboard" text="" /></li>
	</ul>
	<!-- END PAGE BREADCRUMB -->
				...
				<div class="display">
					<div class="number">
						<h3 class="font-green-sharp">
							${totalStudent}<small class="font-green-sharp"></small>
						</h3>
						<small><spring:message code="total.school" text="" /></small>
					</div>
					<div class="icon">
			...
			<div class="dashboard-stat2">
				<div class="display">
					<div class="number">
						...
						<small><spring:message code="total.amount.received" text="" /></small>
					</div>
					<div class="icon">
						<i class="icon-inr"></i>
					</div>
			...
			<div class="dashboard-stat2">
				<div class="display">
					<div class="number">
						...
						<small><spring:message code="total.notice" text="" /></small>
					</div>
					<div class="icon">
						<i class="icon-user"></i>
					</div>
			...
			<div class="portlet light ">
				...
				<div class="portlet-body">
					...
					<div id="sales_statistics"
						class="portlet-body-morris-fit morris-chart" style="height: 260px">
					</div>
				</div>
			</div>
			<!-- END PORTLET-->
		...
		<!-- <div class="col-md-6 col-sm-12">
			...
			<div class="portlet light ">
				<div class="portlet-title">
					<div class="caption caption-md">
						<i class="icon-bar-chart theme-font-color hide"></i> <span
							class="caption-subject theme-font-color bold uppercase">Member
							Activity</span> <span class="caption-helper hide">weekly stats...</span>
					</div>
					<div class="actions">
						<div class="btn-group btn-group-devided" data-toggle="buttons">
							<label
						...
						<table class="table table-hover table-light">
							...
							<tr>
								<td class="fit"><img class="user-pic"
									src="assets/img/layout/avatar4.jpg"></td>
							...
							<tr>
								<td class="fit"><img class="user-pic"
									src="assets/img/layout/avatar5.jpg"></td>
							...
							<tr>
								<td class="fit"><img class="user-pic"
									src="assets/img/layout/avatar6.jpg"></td>
							...
							<tr>
								<td class="fit"><img class="user-pic"
									src="assets/img/layout/avatar7.jpg"></td>
					...
					<div class="scroller" style="height: 305px;"
						...
						<div class="general-item-list">
							<div class="item">
								<div class="item-head">
									<div class="item-details">
										<img class="item-pic" src="images/layout/avatar4.jpg">
										<a href="" class="item-name primary-link">Nick Larson</a> <span
							...
							<div class="item">
								<div class="item-head">
									<div class="item-details">
										<img class="item-pic" src="images/layout/avatar3.jpg">
							...
							<div class="item">
								<div class="item-head">
									<div class="item-details">
										<img class="item-pic" src="images/layout/avatar6.jpg">
										<a href="" class="item-name primary-link">Nick Larson</a> <span
							...
							<div class="item">
								<div class="item-head">
									<div class="item-details">
										<img class="item-pic" src="images/layout/avatar7.jpg">
										<a href="" class="item-name primary-link">Nick Larson</a> <span
							...
							<div class="item">
								<div class="item-head">
									<div class="item-details">
										<img class="item-pic" src="images/layout/avatar9.jpg">
										<a href="" class="item-name primary-link">Richard Stone</a> <span
								...
								<div class="item-body">Lorem ipsum dolor sit amet,
									consectetuer adipiscing elit, ut laoreet dolore magna aliquam
									erat volutpat.</div>
							</div>
							<div class="item">
								<div class="item-head">
									<div class="item-details">
										<img class="item-pic" src="images/layout/avatar8.jpg">
							...
							<div class="item">
								<div class="item-head">
									<div class="item-details">
										<img class="item-pic" src="images/layout/avatar2.jpg">
