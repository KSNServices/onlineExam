...
<div class="page-content">
	...
	<ul
		...
		<li><a href="${pageContext.request.contextPath}/extraActivities/extraActi"><spring:message code="ExtraActivities.extraActi" text="" /></a></li>
	</ul>
	<!-- END PAGE BREADCRUMB -->
		...
		<div class="col-md-12">
			...
			<div class="portlet box lightblue">
				<div class="portlet-title">
					<div class="caption">
						<i class="fa fa-cogs"></i><spring:message code="user.manage.extraActivities" text="" />
					</div>
					<div class="actions">
					...
					<div id="addform" class="<%=style%>">
						<div class="portlet box">
							<div class="portlet-body form">
								<form:form class="form-horizontal" commandName="extraActivities"
									action="${pageContext.request.contextPath}/extraActivities/extraActi"
									...
									<div class="form-body">
										<div class="row">
											<div class="col-md-5  col-md-offset-1">
												<div class="form-group">
													<label class="control-label col-md-4"> <spring:message code="ExtraActivities.activity_name" text="" /><span
											...
											<div class="col-md-5">
												<div class="form-group">
													<label class="control-label col-md-4"><spring:message code="ExtraActivities.date" text="" /><span
														class="astrek" style="color: red"> * </span></label>
													<div class="col-md-8">
										...
										<div class="row">
											<div class="col-md-5 col-md-offset-1">
												<div class="form-group">
													<label class="control-label col-md-4"><spring:message code="ExtraActivities.participants" text="" /></label>
													<div class="col-md-8">
														<form:input id="participants" path="participants"
											...
											<div class="col-md-5">
												<div class="form-group">
													<label class="control-label col-md-4"><spring:message code="ExamSchedule.incharge_teacher" text="" /><span
														class="astrek" style="color: red"> * </span></label>
													<div class="col-md-8">
														<form:input id="inchargeTeacher" path="inchargeTeacher"
															class="form-control" type="text" required="required" />
														<span class="help-block"></span>
													</div>
												</div>
