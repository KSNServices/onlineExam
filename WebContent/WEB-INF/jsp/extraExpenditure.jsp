...
<div class="page-content">
	...
	<ul
		...
		<li><a href="${pageContext.request.contextPath}/extraExpenditure/extraExp"><spring:message code="ExtraExpenditure.extraExp" text="" /></a></li>
	</ul>
	<!-- END PAGE BREADCRUMB -->
		...
		<div class="col-md-12">
			...
			<div class="portlet box lightblue">
				<div class="portlet-title">
					<div class="caption">
						<i class="fa fa-cogs"></i><spring:message code="user.manage.extraExpenditure" text="" />
					</div>
					<div class="actions">
					...
					<div id="addform" class="<%=style%>">
						<div class="portlet box">
							<div class="portlet-body form">
								<form:form class="form-horizontal" commandName="extraExpenditure"
									action="${pageContext.request.contextPath}/extraExpenditure/extraExp"
									...
									<div class="form-body">
										<div class="row">
											<div class="col-md-5  col-md-offset-1">
												<div class="form-group">
													<label class="control-label col-md-4"> <spring:message code="ExtraActivities.expenditure_name" text="" /><span
														class="astrek" style="color: red"> * </span></label>
													<div class="col-md-8">
														<form:input id="expenditureName"   path="expenditureName"
											...
											<div class="col-md-5">
												<div class="form-group">
													<label class="control-label col-md-4"><spring:message code="ExtraActivities.quantity" text="" /><span
														class="astrek" style="color: red"> * </span></label>
													<div class="col-md-8">
										...
										<div class="row">
											<div class="col-md-5 col-md-offset-1">
												<div class="form-group">
													<label class="control-label col-md-4"><spring:message code="ExtraActivities.amount" text="" /></label>
													<div class="col-md-8">
