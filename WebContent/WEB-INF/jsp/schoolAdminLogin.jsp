...
<div class="page-content">
	...
	<ul
		...
		<li><a href="${pageContext.request.contextPath}/schoolUser/schoolAdminLogin"><spring:message code="user.school.admin" text="" /></a></li>
	</ul>
	<!-- END PAGE BREADCRUMB -->
		...
		<div class="col-md-12">
			...
			<div class="portlet box lightblue">
				<div class="portlet-title">
					<div class="caption">
						<i class="fa fa-cogs"></i><spring:message code="user.school.admin" text="" />
					</div>
					<div class="actions">
						...
						<div class="portlet box">
							<div class="portlet-body form">
								<form:form class="form-horizontal" commandName="user"
									action="${pageContext.request.contextPath}/schoolUser/saveSchoolAdmin"
							...
							<tbody>
								<c:forEach items="${userList}" var="user" varStatus="status">
									<tr>
										<td>${status.count}</td>
										<td><img alt=""
											src="${pageContext.request.contextPath}/schoolUser/readUserDisplayImage/${user.id}"
										...
										<td class="display-flex"><a href="javascript:;"
											...
											href="${pageContext.request.contextPath}/schoolUser/editUser/${user.id}"
											data-original-title="Edit"
											class="tooltips btn btn-success btn-xs"> <i
												class="fa fa-pencil"></i>
										</a> <c:if test="${user.enabled}">
												<a
													href="${pageContext.request.contextPath}/schoolUser/enableDisableAdmin/${user.id}/false"
												...
												<a
													href="${pageContext.request.contextPath}/schoolUser/enableDisableAdmin/${user.id}/true"
													data-original-title="Click to Enable"
													class="tooltips btn btn-success btn-xs"> <i
