...
<div class="page-content">
	...
	<ul
		...
		<li><a href="${pageContext.request.contextPath}/user/manageUsers"><spring:message code="user.manage.admin" text="" /></a></li>
	</ul>
	<!-- END PAGE BREADCRUMB -->
		...
		<div class="col-md-12">
			...
			<div class="portlet box lightblue">
				<div class="portlet-title">
					<div class="caption">
						<i class="fa fa-cogs"></i><spring:message code="user.manage.admin" text="" />
					</div>
					<div class="actions">
								...
								<form:form class="form-horizontal" commandName="user"
									...
									<div class="form-body">
										...
										<div class="row">
											<div class="col-md-5 col-md-offset-1">
												<div class="form-group">
													<label class="control-label col-md-4"><spring:message code="user.uniqueadmin.number" text="" /></label>
													<div class="col-md-8">
														<form:input id="userNumber" path="userNumber"
