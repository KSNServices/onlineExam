...
<div class="page-content">
	...
	<ul
		...
		<li><a href="${pageContext.request.contextPath}/examSchedule/examTimeTable"><spring:message code="ExamSchedule.ExamTimeTable" text="" /></a></li>
	</ul>
	<!-- END PAGE BREADCRUMB -->
		...
		<div class="col-md-12">
			...
			<div class="portlet box lightblue">
				<div class="portlet-title">
					<div class="caption">
						<i class="fa fa-cogs"></i><spring:message code="user.manage.examSchedule" text="" />
					</div>
					<div class="actions">
					...
					<div id="addform" class="<%=style%>">
						<div class="portlet box">
							<div class="portlet-body form">
								<form:form class="form-horizontal" commandName="examSchedule"
									action="${pageContext.request.contextPath}/examSchedule/examTimeTable"
									...
									<div class="form-body">
										<div class="row">
											<div class="col-md-5  col-md-offset-1">
												<div class="form-group">
													<label class="control-label col-md-4"> <spring:message code="ExamSchedule.exam_date" text="" /><span
														class="astrek" style="color: red"> * </span></label>
													<div class="col-md-8">
														<form:input id="examDate"   path="examDate"
											...
											<div class="col-md-5">
												<div class="form-group">
													<label class="control-label col-md-4"><spring:message code="ExamSchedule.class" text="" /><span
														class="astrek" style="color: red"> * </span></label>
													<div class="col-md-8">
										...
										<div class="row">
											<div class="col-md-5 col-md-offset-1">
												<div class="form-group">
													<label class="control-label col-md-4"><spring:message code="ExamSchedule.section" text="" /></label>
													<div class="col-md-8">
											...
											<div class="col-md-5">
												<div class="form-group">
													<label class="control-label col-md-4"><spring:message code="ExamSchedule.exam_time" text="" /><span
														class="astrek" style="color: red"> * </span></label>
													<div class="col-md-8">
														<form:input id="examTime" path="examTime"
															class="form-control" type="text" required="required" />
														<span class="help-block"></span>
													</div>
												</div>
										...
										<div class="row">
											<div class="col-md-5 col-md-offset-1">
												<div class="form-group">
													<label class="control-label col-md-4"><spring:message code="ExamSchedule.subject" text="" /><span
														class="astrek" style="color: red"> * </span></label>
													<div class="col-md-8">
											...
											<div class="col-md-5">
												<div class="form-group">
													<label class="control-label col-md-4"><spring:message code="ExamSchedule.teacher_assigned" text="" /><span
														class="astrek" style="color: red"> * </span></label>
													<div class="col-md-8">
														<form:input id="teacherAssigned" path="teacherAssigned"
															class="form-control" type="text" required="required" />
														<span class="help-block"></span>
													</div>
												</div>
...
<%@ include file="/WEB-INF/jsp/common/bottom.jsp"%><%@ include file="/WEB-INF/jsp/common/bottom.jsp"%>